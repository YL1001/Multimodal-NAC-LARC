...
class BasicBlock(nn.Module):
    expansion = 1
    def __init__(self, in_planes, planes, stride=1, downsample=None, SA_ks=3, sigma=0.1):
        super().__init__()
        ...
        self.stride = stride
        self.attention = SpatialAttention3D(kernel_size = SA_ks)
        self.drop = nn.Dropout(sigma) 
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, shortcut_type, stride, SA_ks, sigma):
        downsample = None
